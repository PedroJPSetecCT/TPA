...
public class NovoVelho {
    public static void main(String[] args) {
        ...
        if (id1 < id2 && id1 < id3 && id1 < id4 && id1 < id5) {
            System.out.println("O mais novo é " + n1 + " com " + id1 +" anos.");
        } else if (id2 < id1 && id2 < id3 && id2 < id4 && id2 < id5) {
            System.out.println("O mais novo é " + n2 + " com " + id2 + " anos.");
        } else if (id3 < id1 && id3 < id2 && id3 < id4 && id3 < id5) {
            System.out.println("O mais novo é " + n3 + " com " + id3 + " anos.");
        } else if (id4 < id1 && id4 < id2 && id4 < id3 && id4 < id5) {
            System.out.println("O mais novo é " + n4 + " com " + id4 + " anos.");
        } else {
            System.out.println("O mais novo é " + n5 + " com " + id5 + " anos.");
        }

        if (id1 > id2 && id1 > id3 && id1 > id4 && id1 > id5) {
            System.out.println("O mais velho é " + n1 + " com " + id1 + " anos.");
        } else if (id2 > id1 && id2 > id3 && id2 > id4 && id2 > id5) {
            System.out.println("O mais velho é " + n2 + " com " + id2 + " anos.");
        } else if (id3 > id1 && id3 > id2 && id3 > id4 && id3 > id5) {
            System.out.println("O mais velho é " + n3 + " com " + id3 + " anos.");
        } else if (id4 > id1 && id4 > id2 && id4 > id3 && id4 > id5) {
            System.out.println("O mais velho é " + n4 + " com " + id4 + " anos.");
        } else {
            System.out.println("O mais velho é " + n5 + " com " + id5 + " anos.");
        }
        ler.close();
    }
}